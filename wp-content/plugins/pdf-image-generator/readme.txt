...
The plugin allows you to set PDF as Featured Image and to use get_the_post_thumbnail function directly. (v1.2 or later) *If the plugin is deactivated, this function just will return empty.
<code>
...
= 1.1.6 =
28.June 2015. Disabled pigen_change_icon function only in the static media library.
...
= 1.1 =
3.Feb 2015. Added support for imagick Extension, and added uninstall.php.
