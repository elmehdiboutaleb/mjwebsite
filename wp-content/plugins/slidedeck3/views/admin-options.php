                ...
                <formset>
                    <div class="inner">
                        ...
                        <ul>
                            ...
                            <li>
                           	<?php slidedeck2_html_input( 'last_saved_youtube_api_key', $last_saved_youtube_api_key, array( 'type' => 'password', 'attr' => array( 'class' => 'fancy' ), 'label' => "Last used Youtube API Key" ) ); ?>
                            </li>
                            <li>
