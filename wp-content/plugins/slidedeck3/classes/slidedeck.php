...
//            ),
    ...
    final public function render( $id, $styles = array(), $include_lens_files = true, $preview = false, $echo_js = false, $start = false, $post = null, $front_page ) {
		...
		if( $slidedeck['options']['auto_height'] ){
        ...
        $lens = $SlideDeckPlugin->Lens->get( $slidedeck['lens'] ); // rohan
		...
		/**
		 *  Set default scroll option to false
		 */
		
		$javascript_options['scroll'] = false;
