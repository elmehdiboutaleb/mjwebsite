...
class SlideDeck2Widget extends WP_Widget {
    ...
    function SlideDeck2Widget() {
        $widget_options = array(
            ...
            'description' => 'Add SlideDeck 3 SlideDecks to your widget areas'
        );
        $this->WP_Widget( $this->namespace . '_widget', 'SlideDeck 3 Widget', $widget_options );
    }
